mole: lib/read_params/read_params.o lib/get_index/get_index.o src/main.o  lib/index_pthread/index_pthread.o lib/data_saving/data_saving.o lib/read_commands/read_commands.o
	gcc -Wall -std=gnu99 -o mole src/main.o lib/read_params/read_params.o lib/get_index/get_index.o lib/index_pthread/index_pthread.o lib/data_saving/data_saving.o lib/read_commands/read_commands.o -lpthread -lm 
	make clean
